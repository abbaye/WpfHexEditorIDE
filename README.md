...
| **📐 `.whfmt` Format Language** | Data-driven IDE heart — **790+ definitions** (schema v2.4). Controls: which editor opens a file · how binary formats are parsed · how languages behave in the code editor · how formats are auto-detected. Add a new file type with a `.whfmt` file — no C# needed. Also available as [`whfmt.FileFormatCatalog`](Sources/Core/WpfHexEditor.Core.Definitions/README.md) NuGet. |
