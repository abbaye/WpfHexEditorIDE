...
// File: PluginManifestValidator.cs
// Author: Auto
// Created: 2026-03-06
// Description:
//     Validates a plugin manifest before loading the assembly.
//     Checks required fields, version compatibility, and SHA-256 hash integrity.
//
// Architecture Notes:
//     SHA-256 check only applies to Distribution Manifests (assembly.sha256 non-null).
//     Build Manifests (generated by MSBuild target) skip hash validation.
//     Returns a ValidationResult with a list of all violations found.
//
// ==========================================================
