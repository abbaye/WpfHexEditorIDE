...
// File: AIAssistantOptionsPage.xaml.cs
...
public partial class AIAssistantOptionsPage : UserControl
{
    ...
    private static void SaveKeyIfChanged(string password, string providerId, AIAssistantOptions opts)
    {
