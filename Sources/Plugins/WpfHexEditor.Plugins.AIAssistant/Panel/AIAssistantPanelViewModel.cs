...
// File: AIAssistantPanelViewModel.cs
...
using WpfHexEditor.Plugins.AIAssistant.Panel.History;
using WpfHexEditor.Plugins.AIAssistant.Panel.Tabs;
using WpfHexEditor.Plugins.AIAssistant.Providers.Anthropic;
using WpfHexEditor.Plugins.AIAssistant.Providers.Google;
using WpfHexEditor.Plugins.AIAssistant.Providers.ClaudeCode;
using WpfHexEditor.Plugins.AIAssistant.Providers.Ollama;
using WpfHexEditor.Plugins.AIAssistant.Providers.OpenAI;
using WpfHexEditor.Plugins.AIAssistant.Session;

namespace WpfHexEditor.Plugins.AIAssistant.Panel;

public sealed partial class AIAssistantPanelViewModel : ObservableObject
{
    ...
    public AIAssistantPanelViewModel()
    {
    ...
    private ConversationTabViewModel CreateTabForSession(ConversationSession session)
    {
        ...
        if (session.ProviderId != "ollama" && session.ProviderId != "claude-code"
            && string.IsNullOrEmpty(AIAssistantOptions.Instance.GetApiKey(session.ProviderId))
            && ClaudeCodeModelProvider.FindClaudeExecutable() is not null)
        {
