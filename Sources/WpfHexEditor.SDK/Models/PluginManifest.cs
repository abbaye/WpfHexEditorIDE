...
// Created: 2026-03-06
// Description:
//     Complete plugin manifest model — both Build Manifest (generated at compile time)
//     and Distribution Manifest (enriched by PackagingTool with hash/signature).
//     File name: WpfHexEditor.plugin.json (or manifest.json in build output).
//
// Architecture Notes:
//     Build Manifest: generated by MSBuild target, no hash/signature.
//     Distribution Manifest: PackagingTool adds assembly.sha256, assembly.size, signature.
//     PluginManifestValidator checks the appropriate fields based on presence of sha256.
//
// ==========================================================
