...
|-----------|-------|-------------|----------|
| #100 | **IDE Localization** | Phase 6 complete — 77.9% DynamicResource coverage across all panels, menus, context menus, dialogs, and toolbar buttons. 17 languages wired via per-assembly `LocalizedResourceDictionary` pattern. Remaining: code-behind-set strings (proper nouns, technical configs, icon glyphs intentionally left in English). | ~78% |
...
| **Phase 6 Localization complete** — 77.9% DynamicResource coverage; all panels, menus, context menus, dialogs, and toolbar buttons localized (waves 1–25); per-assembly `LocalizedResourceDictionary` pattern; 17 satellite assemblies per component | [0.6.5.15] — 2026-05-01 |
