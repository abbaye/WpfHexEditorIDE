...
| #229 | **Split view (horizontal / vertical)** | Two synchronized hex panes over the same buffer; independent scroll / selection; great for header-vs-payload comparison. Reuses the docking split engine. |
